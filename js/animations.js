...
const tlLogoBee = new TimelineMax({repeat: -1, ease: Linear.easeNone, delay: 0, paused: true});
...
const tlBeeDrop = new TimelineMax({paused: true});
...
const beeTrigger = document.querySelector('.button--bee-trigger');
